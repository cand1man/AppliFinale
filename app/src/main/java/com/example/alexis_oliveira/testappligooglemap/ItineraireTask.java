...
public class ItineraireTask extends AsyncTask<Void, Integer, Boolean> {
     ...
     * @param arrivee
     */
    public ItineraireTask(final Context context, final GoogleMap gMap, final String depart, final String arrivee) {
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            ...
            url.append(arrivee.replace(' ', '+'));
            url.append("&key=AIzaSyBXqR7QxPkzjDjXfYRmOthsrG7i1mD5XF8");
